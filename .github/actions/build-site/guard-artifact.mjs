...
//   6. no Cloudflare Pages control entry (`_worker.js`, `functions`,
//      `_routes.json`, `_headers`, `_redirects`) at the root of the artifact,
//      whatever shape it has. See PAGES_CONTROL_ENTRIES below; two of them put
//      a Worker in front of a client's site and one can forge this publisher's
//      own gate proof.
